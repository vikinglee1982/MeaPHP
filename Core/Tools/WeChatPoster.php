...
class WeChatPoster
{
    ...
    private function getFontFilePath(): string
    {
        // 检查字体文件是否存在
        // 如果没有指定字体路径，尝试查找内置字体
        if (file_exists(dirname($_SERVER['DOCUMENT_ROOT'])   . "/MeaPHP/Font/Alibaba_PuHuiTi_2.0_55_Regular_55_Regular.ttf")) {
            $fontfile = dirname($_SERVER['DOCUMENT_ROOT'])   . "/MeaPHP/Font/Alibaba_PuHuiTi_2.0_55_Regular_55_Regular.ttf";
        } elseif (file_exists($_SERVER['DOCUMENT_ROOT']   . "/MeaPHP/Font/Alibaba_PuHuiTi_2.0_55_Regular_55_Regular.ttf")) {
            $fontfile = $_SERVER['DOCUMENT_ROOT']   . "/MeaPHP/Font/Alibaba_PuHuiTi_2.0_55_Regular_55_Regular.ttf";
        }
